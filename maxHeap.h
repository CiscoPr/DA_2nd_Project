...
private:
    ...
    /**
     * swaps parameters position in the queue
     * @param V1
     * @param V2
     */
    ...
    /**
     * Checks if parameter is smaller than neighbours and puts it on correct position
     * @param i
     */
    ...
    /**
     * Checks if parameter is bigger than neighbours and puts it on correct position
     * @param i
     */
